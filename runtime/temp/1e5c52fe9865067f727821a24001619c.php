<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"F:\wamp\www\ed2k\public/../application/admin\view\cate\edit.htm";i:1493890821;s:65:"F:\wamp\www\ed2k\public/../application/admin\view\common\head.htm";i:1492440041;s:65:"F:\wamp\www\ed2k\public/../application/admin\view\common\left.htm";i:1493719938;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="pid" style="width: 100%;">
                                    ...
                                    <option <?php if($cate['id'] == $cates['pid']): ?> selected="selected" <?php endif; ?> value="<?php echo $cate['id']; ?>"><?php echo str_repeat('-',$cate['level']*8);?><?php echo $cate['cate_name']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="cate_name" value="<?php echo $cates['cate_name']; ?>" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="pos">
                                    <option <?php if($cates['pos'] == 1): ?> selected="selected" <?php endif; ?> value="1">头部</option>
                                    <option <?php if($cates['pos'] == 2): ?> selected="selected" <?php endif; ?> value="2">底部</option>
                                </select>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="title" value="<?php echo $cates['title']; ?>"  type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="keywords" value="<?php echo $cates['keywords']; ?>"  type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio">
                                    <label>
                                        <input name="type" value="1" <?php if($cates['type'] == 1): ?> checked="checked" <?php endif; ?> class="inverted" type="radio">
                                        <span class="text">列表栏目</span>
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input name="type" <?php if($cates['type'] == 2): ?> checked="checked" <?php endif; ?> value="2" type="radio">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right">栏目内容</label>
                            <div class="col-sm-6">
