<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"F:\wamp\www\ed2k\public/../application/admin\view\article\edit.htm";i:1496740448;s:65:"F:\wamp\www\ed2k\public/../application/admin\view\common\head.htm";i:1492440041;s:65:"F:\wamp\www\ed2k\public/../application/admin\view\common\left.htm";i:1493719938;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post"> 
                        <input type="hidden" name="uid" value="<?php echo $arts['uid']; ?>">
                        <input type="hidden" name="id" value="<?php echo $arts['id']; ?>">
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right">文章标题</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" value="<?php echo $arts['title']; ?>" name="title"  type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio">
                                    <label>
                                        <input name="status" value="1" <?php if($arts['status'] == 1): ?> checked="checked" <?php endif; ?> class="inverted" type="radio">
                                        <span class="text">通过</span>
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input name="status" value="2" <?php if($arts['status'] == 2): ?> checked="checked" <?php endif; ?> type="radio">
                                        <span class="text">待审</span>
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input name="status" value="3" <?php if($arts['status'] == 3): ?> checked="checked" <?php endif; ?> type="radio">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" value="<?php echo $arts['keywords']; ?>" name="keywords"  type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea  class="form-control" name="desc"><?php echo $arts['desc']; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="tags" value="<?php echo $arts['tags']; ?>"  type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio">
                                    <label>
                                        <input name="type" value="1" <?php if($arts['type'] == 1): ?> checked="checked" <?php endif; ?> class="inverted" type="radio">
                                ...
                                <div class="radio">
                                    <label>
                                        <input name="type" value="4" <?php if($arts['type'] == 4): ?> checked="checked" <?php endif; ?> class="inverted" type="radio">
                                ...
                                <div class="radio">
                                    <label>
                                        <input name="type" value="2" <?php if($arts['type'] == 2): ?> checked="checked" <?php endif; ?> type="radio">
                                ...
                                <div class="radio">
                                    <label>
                                        <input name="type" value="3" <?php if($arts['type'] == 3): ?> checked="checked" <?php endif; ?> type="radio">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea  class="form-control" name="dowurl"><?php echo $arts['dowurl']; ?></textarea>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" value="<?php echo $arts['click']; ?>" name="click"  type="text">
                            </div>
                        </div>
