<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"F:\wamp\www\ed2k\public/../application/index\view\member\editsource.html";i:1497238715;s:66:"F:\wamp\www\ed2k\public/../application/index\view\Common\head.html";i:1497271106;s:68:"F:\wamp\www\ed2k\public/../application/index\view\Common\footer.html";i:1496900603;}*/ ?>
...
<div class="CurrentLocation"><b>您的位置：</b><a href="/">首页</a> >> <a href="#">编辑资源</a></div>
...
<div class="reg">
	...
	<p>
		...
		<span class="sfl"><input type="text" id="title" name="title" value="<?php echo $arts['title']; ?>" style="WIDTH: 600px;" /></span>
...
﻿﻿﻿﻿<textarea id="content" name="content"  class="xheditor {tools:'Blocktag,Fontface,FontSize,Bold,Italic,Underline,Strikethrough,FontColor,BackColor,SelectAll,Removeformat,|,Align,List,Outdent,Indent,|,Link,Unlink,Img,Hr,Table,|,Source,Preview,Fullscreen',forcePtag:false,beforeSetSource:ubb2html,beforeGetSource:html2ubb}" style="WIDTH: 600px; HEIGHT: 300px"><?php echo $arts['content']; ?></textarea>
	...
	<p>
		...
		<span style="padding-right:10px;">ed2k<input type="radio" name="type" <?php if($arts['type'] == 1): ?> checked="checked" <?php endif; ?> value="1"></span>
		<span style="padding-right:10px;">磁力地址<input type="radio" name="type" <?php if($arts['type'] == 2): ?> checked="checked" <?php endif; ?> value="2"></span>
		<span style="padding-right:10px;">网盘(注意提取码)<input type="radio" name="type" <?php if($arts['type'] == 3): ?> checked="checked" <?php endif; ?> value="3"></span>
		<span style="padding-right:10px;">迅雷<input type="radio" name="type" <?php if($arts['type'] == 4): ?> checked="checked" <?php endif; ?> value="4"></span>
	</p>

	<p>
		<label for="dowurl">下载链接：</label>
		<span><textarea name="dowurl" style="width: 600px; HEIGHT: 60px"><?php echo $arts['dowurl']; ?></textarea></span>
	</p>
	...
	<p>
		...
		<span>
		<?php if($arts['tags']):
			$tagsArr=explode(',', $arts['tags']);
			foreach($tagsArr as $k=>$v):
		?>
		<input type="text" name="tags[]" value="<?php echo $v;?>" class="input w_115" /> 
		<?php
			endforeach; endif;
		?>
		</span>
