<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"F:\wamp\www\ed2k/application/index\view\member\mySource.html";i:1497437926;s:56:"F:\wamp\www\ed2k/application/index\view\common\head.html";i:1497436133;s:58:"F:\wamp\www\ed2k/application/index\view\common\footer.html";i:1496900603;}*/ ?>
...
<table width="100%" border="0" cellspacing="1" cellpadding="5" class="CommonListArea">
  ...
  <tr class="CommonListCell">
    ...
    <?php if(\think\Session::get('uid') == $userid): ?>
    <td><a href="<?php echo url('Member/editSource',array('aid'=>$arts['id'])); ?>">编辑</a>|<a onclick="return confirm('确定删除该资源？');" href="<?php echo url('Member/delSource',array('aid'=>$arts['id'])); ?>">删除</a></td>
    <?php endif; ?>
  </tr>
